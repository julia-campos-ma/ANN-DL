...
|-|-|-|
|Júlia Campos Magalhães|juliacamposmagalhaes@yahoo.com.bt|[@julia-campos-ma](https://github.com/julia-campos-ma)|
...
* \[ ] *Front matter* com `exercise:` (ou `project:`) e `ai\_use:` preenchidos.
...
&#x20;   O campo `ai\_use` é \*\*obrigatório\*\* em toda entrega. Colaborar com IA é permitido;
